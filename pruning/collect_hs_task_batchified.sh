...
#SBATCH --output="qwen_perturbated_pruning1.txt" # Path to store logs
...
do
    echo "Running collect_hs_task_batchified.py with --model_name $model and --datasets ${perturbated_tasks_set1[@]}"
    srun python collect_hs_task_batchified.py --model_name "$model" --datasets "${perturbated_tasks_set1[@]}"
done